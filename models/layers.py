...
@ide: PyCharm
@author: mesie
@date: 2022/6/10 下午3:41
@summary:
"""
from sys import platform
import torch.nn as nn
from utils.mask_util import sort_by_seq_lens, masked_softmax, weighted_sum
...
class RNNDropout(nn.Dropout):
    ...
    def forward(self, sequences_batch):
        ...
        dropout_mask = functional.dropout(ones, self.p, self.training, inplace=False)
