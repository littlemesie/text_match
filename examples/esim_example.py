...
from utils.lcqmc_util import LCQMC_Dataset
from utils.load_util import load_embeddings
from utils.train_util import train, validate
...
def main(train_file, dev_file, embeddings_file, vocab_file, target_dir,
    ...
    # for step, (q1, q1_lengths, q2, q2_lengths, label) in enumerate(train_loader):
    #     print(q1, q1_lengths, q2, q2_lengths)
    #     break
    ...
    # q1 = torch.randint(0, 10, (16, 10))
    # q1_lengths = torch.randint(1, 5, (16, ))
    # q2 = torch.randint(0, 10, (16, 10))
    # q2_lengths = torch.randint(1, 5, (16,))
    # summary(model, input_data=[q1, q1_lengths, q2, q2_lengths], device='cpu')
...
if __name__ == "__main__":
    main("/home/mesie/python/data/nlp/lcqmc/train.tsv", "/home/mesie/python/data/nlp/lcqmc/dev.tsv",
         "/home/mesie/python/data/token_vec_300.bin", "/home/mesie/python/data/vocab.txt", "models")